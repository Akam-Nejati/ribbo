...
<template>
    <div class="flex flex-col items-center mt-10 sm:mt-14 px-4">
        <div class="w-full max-w-screen-xl">
            <div class="h-[calc(100vh-15rem)] sm:h-[calc(100vh-16.4rem)] md:h-[calc(100vh-17.1rem)]">
                <div class="flex flex-col sm:grid grid-cols-6 sm:grid-rows-6 gap-4 overflow-y-auto rounded-xl h-full">
